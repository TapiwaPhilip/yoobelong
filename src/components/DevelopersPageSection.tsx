    ...
    <section className="py-20 bg-yoogray-50">
      <div className="container-section">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-xl transition-all duration-1000 ease-out opacity-100 translate-y-0">
          ...
          <div className="space-y-8 transition-all duration-1000 ease-out opacity-100 translate-y-0">
            <div>
