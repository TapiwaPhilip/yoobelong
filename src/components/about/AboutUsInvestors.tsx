...
const AboutUsInvestors = () => {
  ...
  return (
    <section className="py-24 md:py-32 investors-section relative overflow-hidden">
      {/* Dynamic background with advanced gradient */}
      <div 
        className="absolute inset-0 bg-gradient-to-tr from-white via-yooblue-50 to-white opacity-70 z-0"
        aria-hidden="true"
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto px-6">
          {investors.map((investor, index) => (
            <Card 
              ...
              className={`group overflow-hidden hover-lift frost-glass border-0 transition-all duration-700 ease-in-out rounded-2xl ${
                isVisible 
