...
const DeveloperSection = () => {
  ...
  return (
    <section id="developers" className="py-24 bg-yoogray-50">
      <div className="container-section max-w-6xl mx-auto px-6 sm:px-8">
        <div className="text-center mb-16">
          <span className="inline-block px-3 py-1 text-sm font-medium rounded-full bg-yooblue-100 text-yooblue-800 mb-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div
            className={`relative h-[520px] rounded-2xl overflow-hidden shadow-xl transition-all duration-1000 ease-out ${
          ...
          <div
            className={`space-y-10 transition-all duration-1000 ease-out delay-300 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"
            }`}
          >
            <div>
              <h3 className="text-2xl font-bold text-yoogray-900 mb-5">Why Partner With Us</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-yoogray-100">
              <h4 className="font-semibold text-yoogray-900 mb-3">Development Partnership Program</h4>
              <p className="text-yoogray-600 mb-5">
              ...
              <Button
                className="bg-yooblue-500 hover:bg-yooblue-600 text-white w-full py-6"
                asChild
              >
                <Link to="/developers">
